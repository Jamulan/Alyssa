...
private:
    ...
    void createInstance() {
        ...
        appInfo.applicationVersion = VK_MAKE_VERSION(0, 1, 0); //Note: increment version here?
    ...
    void createGraphicsPipeline() {
        ...
        VkDynamicState dynamicStates[] = { // not sure if I needed this
    ...
    void createTextureImage() {
        ...
        //transitioned to VK_IMAGE_LAYOUT_SHADER_READONLY_OPTIMAL while geverating mipmaps
    ...
    VkCommandBuffer beginSingleTimeCommands() {
        ...
        allocInfo.commandPool = commandPool; // maybe make a new command pool for this, or not
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        ubo.model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -0.5f)) * glm::scale(glm::mat4(1.0f), glm::vec3(0.5f))* glm::rotate(glm::mat4(1.0f), time * glm::radians(20.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        ubo.view = glm::lookAt(glm::vec3(2.0f, 2.0f, 2.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        ubo.proj = glm::perspective(glm::radians(45.0f), swapChainExtent.width / (float) swapChainExtent.height, 0.0f, 10.f);
        ubo.proj[1][1] *= -1;
