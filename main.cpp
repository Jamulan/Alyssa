...
private:
    ...
    void createImageViews() {
        ...
        for(size_t i = 0; i < swapChainImages.size(); i++) {
            ...
            createInfo.components.r = VK_COMPONENT_SWIZLE_IDENTITY;
            createInfo.components.g = VK_COMPONENT_SWIZLE_IDENTITY;
            createInfo.components.b = VK_COMPONENT_SWIZLE_IDENTITY;
            createInfo.components.a = VK_COMPONENT_SWIZLE_IDENTITY;
