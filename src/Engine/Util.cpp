...
void generateMipmaps(VkPhysicalDevice physicalDevice, VkQueue graphicsQueue, VkDevice device, VkCommandPool commandPool,
...
void
copyBufferToImage(VkDevice device, VkCommandPool commandPool, VkQueue graphicsQueue, VkBuffer buffer, VkImage image,
...
void
copyBuffer(VkDevice device, VkQueue graphicsQueue, VkCommandPool commandPool, VkBuffer srcBuffer, VkBuffer dstBuffer,
           VkDeviceSize size) {
